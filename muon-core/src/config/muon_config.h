 ...
 */
enum MuonBrowserPluginMode : uint32_t {
  /** Expose plugin namespace objects on window-compatible globals. */
  kMuonBrowserPluginModeSimple = 0,
  /** Expose only the capability import bridge for validated imports. */
  kMuonBrowserPluginModeValidate = 1,
};

/**
 * Capability token that allows a virtual module to call plugin functions.
 */
struct MuonBrowserPluginCapabilityConfig {
  /** Opaque capability identifier generated by the bundler integration. */
  std::string id;
  /** Plugin function path patterns allowed for this capability. */
...
struct MuonBrowserPluginConfig {
  ...
  /**
   * Capability policies generated by a bundler integration for validate mode.
   */
  std::vector<MuonBrowserPluginCapabilityConfig> capabilities;
};
...
struct MuonPluginEntryConfig {
  ...
  std::string name;
  /**
   * Whether a plugin library signature was explicitly configured.
   */
