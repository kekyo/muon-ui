...
// Keep signature verification self-contained so asset storage does not gain a
// platform crypto dependency.
...
static std::string CalculateSha1Hex(const std::vector<uint8_t>& data,
